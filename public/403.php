...
<head>
  ...
  <title>403 — Access Denied · Pawganic Supplies</title>
...
<main>
  ...
  <section class="error-hero">
    ...
    <div class="error-hero-inner">
      ...
      <div class="error-number" data-text="403">403</div>

      <div style="height:16px;"></div>
      <div class="error-hero-label"><i class="fas fa-lock"></i> Access Denied</div>

      <h1 class="error-title">
        You've hit a <em>locked gate</em>.
      </h1>

      <p class="error-subtitle">
        The page exists, but you don't have permission to see it. Unlike a 404, the server knows it's there — it's just not letting you in. Don't worry, we can help you find your way back.
      </p>
  ...
  <div class="info-section">
    ...
    <div class="info-card">
      ...
      <h3>What is a 403 Error?</h3>
      <p>A <strong style="color:var(--mahogany)">403 Forbidden</strong> is an HTTP status code returned by the web server when it understands the request, but refuses to authorize it. This means you do not have the required permissions to view the folder, directory, or page you are trying to access.</p>
      <p style="margin-top:12px;">This is commonly used to protect administrative directories, configuration files, and private user areas from public view, preserving the security of our application.</p>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="cause-list">
        <li><i class="fas fa-user-shield"></i><span><strong>Restricted access</strong> — You tried to access an admin area or file that requires administrative clearance.</span></li>
        <li><i class="fas fa-sign-in-alt"></i><span><strong>Not logged in</strong> — Some pages are only available to authenticated users. Try logging in first.</span></li>
        <li><i class="fas fa-folder-open"></i><span><strong>Directory listing disabled</strong> — Trying to view folders directly is blocked for security reasons.</span></li>
        <li><i class="fas fa-user-slash"></i><span><strong>Role mismatch</strong> — Your current account role does not possess the permissions for this specific action.</span></li>
      </ul>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="cause-list">
        <li><i class="fas fa-sign-in-alt"></i><span><strong>Log in again</strong> — Ensure your session hasn't expired and you are using the correct account credentials.</span></li>
        <li><i class="fas fa-undo"></i><span><strong>Go back</strong> — Hit the back button or navigate back to safe public parts of the site.</span></li>
        <li><i class="fas fa-spell-check"></i><span><strong>Check the URL</strong> — Make sure you didn't accidentally request direct access to config/system files.</span></li>
        <li><i class="fas fa-envelope"></i><span><strong>Contact administration</strong> — If you believe you should have access to this resource, email our support team.</span></li>
      </ul>
    </div>
