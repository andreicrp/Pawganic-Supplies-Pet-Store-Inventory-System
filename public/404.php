...
<head>
  ...
  <title>404 — Page Not Found · Pawganic Supplies</title>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hd2 { width: 260px; height: 260px; bottom: 0px;  left: 3%;  }
  .hd3 { width: 140px; height: 140px; top:  20px; left: 28%; opacity: 0.04; }
...
<main>
  ...
  <section class="error-hero">
    ...
    <div class="error-hero-inner">
      ...
      <div class="error-number" data-text="404">404</div>

      <div style="height:16px;"></div>
      <div class="error-hero-label"><i class="fas fa-exclamation-triangle"></i> Page Not Found</div>

      <h1 class="error-title">
        This page <em>went exploring</em><br>and never came back.
      </h1>

      <p class="error-subtitle">
        Like a curious cat that slipped out the door, the page you're looking for has wandered off somewhere we can't find it. Don't worry — we'll help you find your way home.
      </p>
  ...
  <div class="info-section">
    ...
    <!-- What is a 404? -->
    <div class="info-card">
      <div class="info-card-icon"><i class="fas fa-question"></i></div>
      <div class="section-eyebrow">What happened</div>
      <h3>What is a 404 Error?</h3>
      <p>A <strong style="color:var(--mahogany)">404 Not Found</strong> is an HTTP status code — the server's way of telling your browser it received the request perfectly, but the page you asked for simply doesn't exist at that address. It's one of the most common errors on the web, and it's completely harmless.</p>
      <p style="margin-top:12px;">The number "404" is part of a standardized language browsers and servers use to communicate. 4xx codes always mean a client-side issue — meaning the address was probably wrong or the resource was moved.</p>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="cause-list">
        <li><i class="fas fa-link"></i><span><strong>Broken or outdated link</strong> — A link you clicked may point to a page that was moved, renamed, or deleted.</span></li>
        <li><i class="fas fa-keyboard"></i><span><strong>Typo in the URL</strong> — A small spelling mistake in the address bar is enough for this error to appear.</span></li>
        <li><i class="fas fa-trash-alt"></i><span><strong>Page was removed</strong> — The content may have been intentionally taken down or reorganized.</span></li>
        <li><i class="fas fa-bookmark"></i><span><strong>Old bookmark</strong> — Bookmarks saved months ago may point to addresses that no longer exist.</span></li>
        <li><i class="fas fa-server"></i><span><strong>Server misconfiguration</strong> — Rare, but sometimes a routing rule is missing on the server side.</span></li>
      </ul>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="cause-list">
        <li><i class="fas fa-redo"></i><span><strong>Refresh the page</strong> — Sometimes a temporary glitch causes this. Press F5 or Ctrl+R.</span></li>
        <li><i class="fas fa-spell-check"></i><span><strong>Check the URL carefully</strong> — Look for typos, extra slashes, or missing characters in the address bar.</span></li>
        <li><i class="fas fa-home"></i><span><strong>Start from the homepage</strong> — Navigate back to our home page and find what you need from there.</span></li>
        <li><i class="fas fa-history"></i><span><strong>Clear your browser cache</strong> — Cached data can sometimes send you to a stale or removed address.</span></li>
        <li><i class="fas fa-envelope"></i><span><strong>Report the issue</strong> — If you arrived from a link on our site, contact us at <a href="mailto:meow@pawganic.com" style="color:var(--gold);font-weight:600;">meow@pawganic.com</a>.</span></li>
      </ul>
    </div>
