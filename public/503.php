...
<head>
  ...
  <title>503 — Service Unavailable · Pawganic Supplies</title>
...
<main>
  ...
  <section class="error-hero">
    ...
    <div class="error-hero-inner">
      ...
      <div class="error-number" data-text="503">503</div>

      <div style="height:16px;"></div>
      <div class="error-hero-label"><i class="fas fa-tools"></i> Service Unavailable</div>

      <h1 class="error-title">
        We are doing a little <em>grooming</em>.
      </h1>

      <p class="error-subtitle">
        The server is alive but not ready to handle requests — usually due to maintenance or being temporarily overwhelmed. Try again in a few minutes.
      </p>
  ...
  <div class="info-section">
    ...
    <div class="info-card">
      ...
      <h3>What is a 503 Error?</h3>
      <p>An <strong style="color:var(--mahogany)">HTTP 503 Service Unavailable</strong> error is a status code returned by the web server when it is temporarily unable to handle the request. This is typically a temporary state that will be resolved after some delay.</p>
      <p style="margin-top:12px;">This is commonly used during maintenance updates, backups, or when the server is experiencing high spikes in traffic and needs to preserve system resources.</p>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="cause-list">
        <li><i class="fas fa-wrench"></i><span><strong>Scheduled maintenance</strong> — The site is undergoing updates, software upgrades, or database schema changes.</span></li>
        <li><i class="fas fa-chart-line"></i><span><strong>Server overload</strong> — A sudden spike in visitor traffic exceeded the concurrent connection capacity.</span></li>
        <li><i class="fas fa-spinner"></i><span><strong>Application server down</strong> — The backend server application is temporarily offline, restarting, or crashed.</span></li>
        <li><i class="fas fa-shield-alt"></i><span><strong>Rate-limiting throttling</strong> — Your IP address exceeded rate limits and is temporarily throttled for security.</span></li>
      </ul>
    </div>
    ...
    <div class="info-card">
      ...
      <ul class="cause-list">
        <li><i class="fas fa-redo"></i><span><strong>Refresh the page</strong> — In many instances, the server recovers quickly. Refresh (F5 or Ctrl+F5) after 30 seconds.</span></li>
        <li><i class="fas fa-clock"></i><span><strong>Try again later</strong> — Wait a few minutes before trying your request again.</span></li>
        <li><i class="fas fa-wifi"></i><span><strong>Check network</strong> — Verify that your network is healthy and there are no DNS resolver issues.</span></li>
        <li><i class="fas fa-envelope"></i><span><strong>Contact support</strong> — Reach out to our system status admins at <a href="mailto:meow@pawganic.com" style="color:var(--gold);font-weight:600;">meow@pawganic.com</a>.</span></li>
      </ul>
    </div>
